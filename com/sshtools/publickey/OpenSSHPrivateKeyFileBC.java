...
implements SshPrivateKeyFile {
    ...
    OpenSSHPrivateKeyFileBC(byte[] formattedkey) throws IOException {
        if (!OpenSSHPrivateKeyFileBC.isFormatted(formattedkey)) {
    ...
    public OpenSSHPrivateKeyFileBC(SshKeyPair pair, String passphrase) throws IOException {
    ...
    public SshKeyPair toKeyPair(String passphrase) throws IOException, InvalidPassphraseException {
        ...
        try (PEMParser pem = new PEMParser((Reader)r);){
            ...
            if (obj instanceof PKCS8EncryptedPrivateKeyInfo) {
                ...
                InputDecryptorProvider pkcs8Prov = new JcePKCSPBEInputDecryptorProviderBuilder().setProvider(JCEProvider.getBCProvider().getName()).build(passphrase == null ? new char[]{} : passphrase.toCharArray());
