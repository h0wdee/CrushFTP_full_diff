...
public class FsCtlPipePeekResponse {
    ...
    public void read(Buffer buffer) throws Buffer.BufferException {
        this.state = EnumWithValue.EnumUtils.valueOf(buffer.readUInt32(), PipeState.class, null);
    ...
    public static enum PipeState implements EnumWithValue<PipeState>
    {
