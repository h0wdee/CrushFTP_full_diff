...
extends SpnegoToken {
    ...
    public void write(Buffer<?> buffer) throws SpnegoException {
        ArrayList<ASN1Object> negTokenTarg = new ArrayList<ASN1Object>();
        try {
            ...
            this.writeGss(buffer, new ASN1Sequence(negTokenTarg));
        }
        catch (IOException e) {
    ...
    private NegTokenTarg read(Buffer<?> buffer) throws SpnegoException {
        try (ASN1InputStream is = new ASN1InputStream((ASN1Decoder)new DERDecoder(), buffer.asInputStream());){
            Object instance = is.readObject();
            this.parseSpnegoToken((ASN1Object)instance);
        }
        catch (IOException e) {
    ...
    protected void parseTagged(ASN1TaggedObject asn1TaggedObject) throws SpnegoException {
        switch (asn1TaggedObject.getTagNo()) {
            case 0: {
                this.readNegResult(asn1TaggedObject.getObject());
                break;
            }
            case 1: {
                this.readSupportedMech(asn1TaggedObject.getObject());
                break;
            }
            case 2: {
                this.readResponseToken(asn1TaggedObject.getObject());
                break;
            }
            case 3: {
                this.readMechListMIC(asn1TaggedObject.getObject());
                break;
            }
            default: {
