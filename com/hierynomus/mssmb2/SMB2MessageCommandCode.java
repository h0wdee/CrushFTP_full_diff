...
public enum SMB2MessageCommandCode {
    ...
    static {
        ...
        SMB2MessageCommandCode[] sMB2MessageCommandCodeArray = SMB2MessageCommandCode.values();
        int n = sMB2MessageCommandCodeArray.length;
        for (int i = 0; i < n; ++i) {
            SMB2MessageCommandCode smb2MessageCommandCode;
            SMB2MessageCommandCode.cache[smb2MessageCommandCode.getValue()] = smb2MessageCommandCode = sMB2MessageCommandCodeArray[i];
        }
    }
}
