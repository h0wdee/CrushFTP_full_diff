...
extends Transport {
            ...
            block24: {
                ...
                block25: {
                    ...
                    try {
                        ...
                        if (!useAuth && (user == null || password == null) || !this.supportsExtension("AUTH") && !this.supportsExtension("AUTH=LOGIN")) break block24;
                        if (this.logger.isLoggable(Level.FINE)) {
                            this.logger.fine("protocolConnect login, host=" + host + ", user=" + this.traceUser(user) + ", password=" + this.tracePassword(password));
                        }
                        bl2 = connected = this.authenticate(user, password);
    ...
    private boolean authenticate(String user, String passwd) throws MessagingException {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (mechs == this.defaultAuthenticationMechanisms && (disabled = PropUtil.getBooleanSessionProperty(this.session, dprop = "mail." + this.name + ".auth." + m.toLowerCase(Locale.ENGLISH) + ".disable", !a.enabled()))) {
    ...
    extends Authenticator {
        ...
        String getInitialResponse(String host, String authzid, String user, String passwd) throws MessagingException, IOException {
            ...
            if (authzid != null) {
                ((OutputStream)b64os).write(ASCIIUtility.getBytes(authzid));
            }
            ...
            try {
                block31: {
                    try {
                        ...
                        if (this.resp != 334) break block31;
                        ...
                        if (thrown == null) throw new AuthenticationFailedException(SMTPTransport.this.getLastServerResponse());
                        ...
                        if ($assertionsDisabled) throw new AuthenticationFailedException(SMTPTransport.this.getLastServerResponse());
                        throw new AssertionError((Object)"unknown Throwable");
                    }
                    catch (Throwable t) {
