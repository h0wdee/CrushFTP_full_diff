...
public class DecryptionJwkSelectorTest {
    ...
    public void someX5Selections() throws Exception {
        ...
        Assert.assertTrue((boolean)(selected instanceof RsaJsonWebKey));
        ...
        Assert.assertTrue((boolean)(selected instanceof EllipticCurveJsonWebKey));
        jwe = new JsonWebEncryption();
    ...
    public void someKidSelections() throws Exception {
        ...
        selectedList = selector.selectList(jwe, jwks);
        Assert.assertTrue((boolean)selectedList.isEmpty());
        jwe = new JsonWebEncryption();
        jwe.setAlgorithmHeaderValue("ECDH-ES");
        ...
        jwe = new JsonWebEncryption();
        jwe.setAlgorithmHeaderValue("ECDH-ES+A128KW");
        jwe.setKeyIdHeaderValue("__8lh94");
        selectedList = selector.selectList(jwe, jwks);
        Assert.assertTrue((boolean)selectedList.isEmpty());
    }
    ...
    public void someKidSymmetricSelections() throws Exception {
        String json = "{\"keys\":[{\"kty\":\"oct\",\"kid\":\"one\", \"k\":\"1gfpc39Jq5H5eR_JbwmAojgUlHIH0GoKz7COzLY1nRE\"},{\"kty\":\"oct\",\"kid\":\"deux\",\"k\":\"9vlp7BLzRr-a9pOKK7BA25o88u6cY2o9Lz6--FfSWXw\"},{\"kty\":\"oct\",\"kid\":\"tres\",\"k\":\"i001zDJd6-7rP5pnldgK-jcDjT8N12o3bIjwgeWAYEc\"},{\"kty\":\"oct\",\"kid\":\"quatro\",\"k\":\"_-cqzgJ-_aeZkppR2JCOlx\"},{\"kty\":\"oct\",\"kid\":\"cinque\",\"k\":\"FFsrZpj_Fbeal88Rz0c2Lk\"},{\"kty\":\"oct\",\"kid\":\"sechs\", \"k\":\"ad2-dGiAp8czx9310j4o70\"}]}";
        JsonWebKeySet jsonWebKeySet = new JsonWebKeySet(json);
        List<JsonWebKey> jwks = jsonWebKeySet.getJsonWebKeys();
        DecryptionJwkSelector selector = new DecryptionJwkSelector();
        JsonWebEncryption jwe = new JsonWebEncryption();
        ...
        Assert.assertThat((Object)1, (Matcher)CoreMatchers.equalTo((Object)selectedList.size()));
        JsonWebKey selected = selector.select(jwe, jwks);
        Assert.assertThat((Object)"tres", (Matcher)CoreMatchers.equalTo((Object)selected.getKeyId()));
        jwe = new JsonWebEncryption();
        ...
        Assert.assertThat((Object)"quatro", (Matcher)CoreMatchers.equalTo((Object)selected.getKeyId()));
    }
}
